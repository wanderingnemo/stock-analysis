...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ListedCompany.symbol'
        db.alter_column('core_listedcompany', 'symbol', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'ListedCompany.symbol'
        db.alter_column('core_listedcompany', 'symbol', self.gf('django.db.models.fields.CharField')(max_length=10))
